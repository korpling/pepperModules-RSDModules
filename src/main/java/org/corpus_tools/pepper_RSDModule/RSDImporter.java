...
/**
 * RSD format implementation of a {@link PepperImporter}.
 * 
 * @author Amir Zeldes
 */
@Component(name = "RSDImporterComponent", factory = "PepperImporterComponentFactory")
public class RSDImporter extends PepperImporterImpl implements PepperImporter{

        private static final Logger logger = LoggerFactory.getLogger(RSDImporter.class);

	public RSDImporter() {
		super();
		this.setName("RSDImporter");
		setSupplierContact(URI.createURI(PepperConfiguration.EMAIL));
		setSupplierHomepage(URI.createURI(PepperConfiguration.HOMEPAGE));
		setDesc("This is an importer module for the RSD format.");

                this.addSupportedFormat("RSD", "3.0", null);
	...
	public PepperMapper createPepperMapper(Identifier Identifier) {
		RSD2SaltMapper mapper = new RSD2SaltMapper();
                return (mapper);
	}
